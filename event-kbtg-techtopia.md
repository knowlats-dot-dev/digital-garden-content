...
KBTG Techtopia เป็น [[event|Events]] ประเภท Tech conference ของ KBTG ที่จะจัดขึ้นทุกปี ปีนี้เน้นเรื่อง [[ai|AI]]
...
- Managing Knowledge Publicly: Unlocking Unexpected Growth โดยพี่ไท และน้องภูมิ = จดโน้ตเก็บความรู้ยังไงให้มีประสิทธิภาพ สรุปมี 3 วิธีที่ทำได้คือ ทำเป็น [[second-brain|Second Brain]], Share in Public, และ [[digital-garden|Digital Garden]] 3 รูปแบบนี้ไม่มีสูตรตายตัว สามารถ Apply ทำเป็นแบบของเราได้เลย มี Keyword และตัวอย่างที่ทำด้วย [ดูที่ลิงก์นี้](https://www.tldraw.com/f/iQnehihcvmHIzZ9HFpZBK?d=v-537.-594.2478.2442.K1qzCskP5wx_E4RnhJ995) ฟังแล้วอยากใช้ Obsidian เลย เพราะตอนนี้เรายังใช้ Notion และมี pain เรื่องการจัดหมวดหมู่โน้ตเพราะ Notion เป็น folder-page Based ทำให้การ manage โน้ตไม่ flexible เท่าไหร่ สุดท้ายจัดไม่ถูก = เละ (บางทีเราอาจไม่เหมาะกับโครงสร้างแบบนี้ก็ได้)
